                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xxl-9" style="width:72%">
                        <div class="row g-4">
			                                ...
			                                <div class="product-card-1">
			                                    <div class="product-card-image">
			                                        <div class="product-media">
			                                            <a href="${pageContext.request.contextPath}/user/book/detail?bookid=${bookcollect.bookEntity.id}" 
					                                    	title="${bookcollect.bookEntity.bookname}">
					                                        <img class="img-fluid" src="/${appMediaUrl }/${bookcollect.bookEntity.image }" 
					                                        	title="${bookcollect.bookEntity.bookname}"
																style="height:235px;overflow: hidden;border-radius: 5px 5px 0px 0px;">
					                                    </a>
			                                            <div class="product-cart-btn">
			                                                <a href="javascript:deleteBatch(${bookcollect.id }false)"
			                                    ...
			                                    <div class="product-card-info">
			                                        <h6 class="product-title text-break text-truncate">
			                                            <a href="${pageContext.request.contextPath}/user/book/detail?bookid=${bookcollect.bookEntity.id}" 
					                                    	title="${bookcollect.bookEntity.bookname}">
					                                    	${bookcollect.bookEntity.bookname}
					                                    </a>
			                                        </h6>
			                                        <div class="product-price">
			                                            <span class="text-muted"><small>${bookcollect.createtime }</small></span>
			                                        </div>                                       
			                                    </div>
			                                </div>
			                            </div>
                       	...
                       	<form action="${pageContext.request.contextPath}/user/bookcollect/list" method="post" id="form">
		...
		<script type="text/javascript">
			...
			function deleteBatch(ids,selectAll){
			    ...
			    layer.confirm("确认删除？",{icon:7,title:"删除"},function(index){
				   layer.close(index);
				   var data = "ids="+ids;
			       common_ajax_other("user/bookcollect/deleteBatch",data);
			   	});
			}
	    </script>
	</body>
