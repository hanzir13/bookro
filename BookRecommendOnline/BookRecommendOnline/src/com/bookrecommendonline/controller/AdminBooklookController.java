...
@Controller
@Scope("prototype")
@RequestMapping(value = "admin/booklook")
public class AdminBooklookController extends BaseController{
	...
	public Object deleteBatch(String ids){
		...
		if(ids!=null && !ids.equals("")){
			...
			if(idArray!=null && idArray.length>0){
				success = booklookService.deleteBatch(idArray);
			}
		}
