...
public class ValCodeTool {
	...
	public String getValCode(HttpServletRequest request,
			HttpServletResponse response,String operationName) throws Exception{
		int width = 120;
		int height = 38;
		...
		// 设置输出字体
		graphics2d.setFont(new Font("宋体", Font.PLAIN, 22));
		...
		request.getSession().setAttribute(operationName, sb.toString());

		// 步骤五 绘制干扰线
		graphics.setColor(getRandColor(180, 220));
		int x1;
		int x2;
		int y1;
		int y2;
